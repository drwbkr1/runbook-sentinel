...
Release checkpoint `v0.0.27` is verified on merged public `main` and prepared for source/zipapp publication without changing agent behavior or authority. PR `#25` merged exact reviewed head `eb057438113573e1fdecd459b6843b7fd8902d01` with history preserved as `70d90e015b0ef0cadc8222c18113517de941d41d`. Fresh public-main source, zipapp, hardened real surfaces, two selected-input image builds, and an independent no-alternates clean build pass all 43 frozen checks at exact image ID `sha256:4a29935f0b2db110d6dfad8617aea821529feb7fd6ba9e8ad70f2ab6563d84ee`; final audit commit `f7fbdc8e0a771f8e109d6ad9bb979bda223ee232` authorizes only the exact closure, annotated tag, selected zipapp/checksum, and immediate public verification. The image is not exported, pushed, or published; consult `docs/status.md` for live publication state.
