...
Current release: `v0.0.6`, a synthetic-only research preview that explicitly grades evidence-condition coverage across development and held-out splits while retaining exact isolated approval/execution trajectories, terminal state, and the excluded local-model comparison. Public source availability does not imply production readiness or authorization to connect it to operational infrastructure.
