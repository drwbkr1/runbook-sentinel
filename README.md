...
Current release: `v0.0.3`, a synthetic-only research preview. Public source availability does not imply production readiness or authorization to connect it to operational infrastructure.
