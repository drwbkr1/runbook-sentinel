...
```powershell
$env:PYTHONPATH = 'src'
python -m runbook_sentinel evaluate --output artifacts/evaluations/runs/baseline-0030-manual.json
...
python scripts/verify_package_contract.py --contract eval/package-contract-0030.json --archive dist/runbook-sentinel-0.0.30.pyz
python dist/runbook-sentinel-0.0.30.pyz --help
```
