...
Candidate `v0.0.17` adds an exact sibling endpoint anchor for live CLI, API, and MCP traces and fails closed on missing, orphaned, stale, malformed, truncated, extra-suffix, or wrong-file states before resume. Its selected local 392,954-byte zipapp is SHA-256 `271242d6eabffd4205f8b386028073f6d041b6ec5cc9369a524e45cacc9fe1ef`; an exact remote-only clean clone passes, while review and public-release gates remain pending. The anchor is unkeyed and same-authority, so it is not writer authentication, hostile-writer resistance, immutable storage, non-repudiation, a digital signature, or directory-entry durability.
