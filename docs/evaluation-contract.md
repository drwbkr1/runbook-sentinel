...
- `container-runtime-v1` freezes one Chainguard Free Python OCI index, selected linux/amd64 manifest, exact Dockerfile and build-context lines, runtime controls, required real surfaces, and 36 receipt checks before any Dockerfile or image exists.
