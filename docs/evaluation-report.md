...
Status: public baseline-0010 remains the latest verified checkpoint. Baseline-0011 is stopped and unpublished. The corrected local baseline-0012 v0.0.12 package candidate passes frozen evaluation and real-surface gates; renewed clean-clone and public-release verification remain pending. `fresh-content-stale-metadata-context-v3` remains selected, the baseline-0004 local-model candidate remains excluded, and deterministic control remains the default.
