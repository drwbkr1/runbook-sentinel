...
class ModelAdapterTest(unittest.TestCase):
    ...
    def test_candidate_evaluation_reports_model_metrics_without_tools(self):
        ...
        self.assertEqual(report["metrics"]["cost"]["model_calls"], 42)
        self.assertEqual(report["metrics"]["cost"]["prompt_tokens"], 42 * 101)
        self.assertEqual(report["metrics"]["cost"]["completion_tokens"], 42 * 33)
