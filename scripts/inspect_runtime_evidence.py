...
def main() -> None:
    database = ROOT / "var/live-api-baseline-0031.db"
    trace = ROOT / "artifacts/runtime/live-api-baseline-0031-traces.jsonl"
    ...
    screenshot = ROOT / "artifacts/verification/dashboard-baseline-0031.png"
    stdout_log = ROOT / "artifacts/runtime/live-api-baseline-0031-stdout.log"
    stderr_log = ROOT / "artifacts/runtime/live-api-baseline-0031-stderr.log"
    required = [
        database,
        trace,
        trace_anchor,
    ...
    output = ROOT / "artifacts/verification/native-baseline-0031.json"
