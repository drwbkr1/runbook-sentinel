...
$stdoutPath = Join-Path (Get-Location) 'artifacts\runtime\live-api-baseline-0026-stdout.log'
$stderrPath = Join-Path (Get-Location) 'artifacts\runtime\live-api-baseline-0026-stderr.log'
$databasePath = Join-Path (Get-Location) 'var\live-api-baseline-0026.db'
$tracePath = Join-Path (Get-Location) 'artifacts\runtime\live-api-baseline-0026-traces.jsonl'
...
$serverArgs = @(
    ...
    '--host', '127.0.0.1',
    '--port', '8877',
    '--db', 'var\live-api-baseline-0026.db',
    '--trace', 'artifacts\runtime\live-api-baseline-0026-traces.jsonl',
...
try {
    ...
    $screenshotPath = Join-Path (Get-Location) 'artifacts\verification\dashboard-baseline-0026.png'
    & $edge `
        --headless `
        --disable-gpu `
        --hide-scrollbars `
    ...
    $traceText = Get-Content -Raw 'artifacts\runtime\live-api-baseline-0026-traces.jsonl'
    ...
    $verification = [pscustomobject]@{
        ...
        dashboard_baseline_0026 = $dashboardResponse.Content.Contains('Baseline 0026')
    ...
    $checks = [ordered]@{
        ...
        checkpoint_exact = $verification.checkpoint -eq 'baseline-0026'
        ...
        evaluation_checkpoint_exact = $verification.evaluation_checkpoint -eq 'baseline-0026'
        ...
        dashboard_baseline_exact = [bool]$verification.dashboard_baseline_0026
