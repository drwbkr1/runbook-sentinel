...
$stdoutPath = Join-Path (Get-Location) 'artifacts\runtime\live-api-baseline-0033-stdout.log'
$stderrPath = Join-Path (Get-Location) 'artifacts\runtime\live-api-baseline-0033-stderr.log'
$databasePath = Join-Path (Get-Location) 'var\live-api-baseline-0033.db'
$tracePath = Join-Path (Get-Location) 'artifacts\runtime\live-api-baseline-0033-traces.jsonl'
...
$serverArgs = @(
    ...
    '--host', '127.0.0.1',
    '--port', '8877',
    '--db', 'var\live-api-baseline-0033.db',
    '--trace', 'artifacts\runtime\live-api-baseline-0033-traces.jsonl',
...
try {
    ...
    $screenshotPath = Join-Path (Get-Location) 'artifacts\verification\dashboard-baseline-0033.png'
    & $edge `
        --headless `
        --disable-gpu `
        --hide-scrollbars `
    ...
    $traceText = Get-Content -Raw 'artifacts\runtime\live-api-baseline-0033-traces.jsonl'
    ...
    $verification = [pscustomobject]@{
        ...
        evaluation_adversarial_exposure_stage_outcome_split_coverage = $evaluation.metrics.coverage.adversarial_exposure_stage_outcome_split_coverage
        evaluation_adversarial_retrieval_stage_outcome_split_coverage = $evaluation.metrics.coverage.adversarial_retrieval_stage_outcome_split_coverage
        ...
        dashboard_baseline_0033 = $dashboardResponse.Content.Contains('Baseline 0033')
        dashboard_stale_baseline_absent = -not ($dashboardResponse.Content.Contains('Baseline 0010') -or $dashboardResponse.Content.Contains('Baseline 0011') -or $dashboardResponse.Content.Contains('Baseline 0012') -or $dashboardResponse.Content.Contains('Baseline 0013') -or $dashboardResponse.Content.Contains('Baseline 0014') -or $dashboardResponse.Content.Contains('Baseline 0015') -or $dashboardResponse.Content.Contains('Baseline 0016') -or $dashboardResponse.Content.Contains('Baseline 0017') -or $dashboardResponse.Content.Contains('Baseline 0018') -or $dashboardResponse.Content.Contains('Baseline 0019') -or $dashboardResponse.Content.Contains('Baseline 0020') -or $dashboardResponse.Content.Contains('Baseline 0021') -or $dashboardResponse.Content.Contains('Baseline 0022') -or $dashboardResponse.Content.Contains('Baseline 0023') -or $dashboardResponse.Content.Contains('Baseline 0024') -or $dashboardResponse.Content.Contains('Baseline 0025') -or $dashboardResponse.Content.Contains('Baseline 0026') -or $dashboardResponse.Content.Contains('Baseline 0027') -or $dashboardResponse.Content.Contains('Baseline 0028') -or $dashboardResponse.Content.Contains('Baseline 0029') -or $dashboardResponse.Content.Contains('Baseline 0030'))
        ...
        dashboard_adversarial_exposure_stage_outcome_split_metric = $dashboardResponse.Content.Contains('Adversarial exposure-stage/outcome split')
    ...
    $checks = [ordered]@{
        ...
        checkpoint_exact = $verification.checkpoint -eq 'baseline-0033'
        ...
        evaluation_checkpoint_exact = $verification.evaluation_checkpoint -eq 'baseline-0033'
        ...
        evaluation_adversarial_exposure_stage_outcome_split_coverage = $verification.evaluation_adversarial_exposure_stage_outcome_split_coverage -eq 1.0
        evaluation_adversarial_retrieval_stage_outcome_split_coverage = $verification.evaluation_adversarial_retrieval_stage_outcome_split_coverage -eq 1.0
        ...
        dashboard_baseline_exact = [bool]$verification.dashboard_baseline_0033
        ...
        dashboard_adversarial_exposure_stage_outcome_split_metric_present = [bool]$verification.dashboard_adversarial_exposure_stage_outcome_split_metric
