...
$stdoutPath = Join-Path (Get-Location) 'artifacts\runtime\live-api-baseline-0019-stdout.log'
$stderrPath = Join-Path (Get-Location) 'artifacts\runtime\live-api-baseline-0019-stderr.log'
$databasePath = Join-Path (Get-Location) 'var\live-api-baseline-0019.db'
$tracePath = Join-Path (Get-Location) 'artifacts\runtime\live-api-baseline-0019-traces.jsonl'
...
$serverArgs = @(
    ...
    '--host', '127.0.0.1',
    '--port', '8877',
    '--db', 'var\live-api-baseline-0019.db',
    '--trace', 'artifacts\runtime\live-api-baseline-0019-traces.jsonl',
...
try {
    ...
    $screenshotPath = Join-Path (Get-Location) 'artifacts\verification\dashboard-baseline-0019.png'
    & $edge `
        --headless `
        --disable-gpu `
        --hide-scrollbars `
    ...
    $traceText = Get-Content -Raw 'artifacts\runtime\live-api-baseline-0019-traces.jsonl'
    ...
    $verification = [pscustomobject]@{
        ...
        dashboard_baseline_0019 = $dashboardResponse.Content.Contains('Baseline 0019')
    ...
    $checks = [ordered]@{
        ...
        checkpoint_exact = $verification.checkpoint -eq 'baseline-0019'
        ...
        evaluation_checkpoint_exact = $verification.evaluation_checkpoint -eq 'baseline-0019'
        ...
        dashboard_baseline_exact = [bool]$verification.dashboard_baseline_0019
