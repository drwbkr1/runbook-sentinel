...
$stdoutPath = Join-Path (Get-Location) 'artifacts\runtime\live-api-baseline-0035-stdout.log'
$stderrPath = Join-Path (Get-Location) 'artifacts\runtime\live-api-baseline-0035-stderr.log'
...
$serverArgs = @(
    ...
    '--host', '127.0.0.1',
    '--port', '8877',
    '--db', 'var\live-api-baseline-0035.db',
    '--trace', 'artifacts\runtime\live-api-baseline-0035-traces.jsonl',
...
try {
    ...
    $traceText = Get-Content -Raw 'artifacts\runtime\live-api-baseline-0035-traces.jsonl'
    ...
    $verification = [pscustomobject]@{
        ...
        dashboard_baseline_0035 = $dashboardResponse.Content.Contains('Baseline 0035')
        dashboard_stale_baseline_absent = -not ($dashboardResponse.Content.Contains('Baseline 0010') -or $dashboardResponse.Content.Contains('Baseline 0011') -or $dashboardResponse.Content.Contains('Baseline 0012') -or $dashboardResponse.Content.Contains('Baseline 0013') -or $dashboardResponse.Content.Contains('Baseline 0014') -or $dashboardResponse.Content.Contains('Baseline 0015') -or $dashboardResponse.Content.Contains('Baseline 0016') -or $dashboardResponse.Content.Contains('Baseline 0017') -or $dashboardResponse.Content.Contains('Baseline 0018') -or $dashboardResponse.Content.Contains('Baseline 0019') -or $dashboardResponse.Content.Contains('Baseline 0020') -or $dashboardResponse.Content.Contains('Baseline 0021') -or $dashboardResponse.Content.Contains('Baseline 0022') -or $dashboardResponse.Content.Contains('Baseline 0023') -or $dashboardResponse.Content.Contains('Baseline 0024') -or $dashboardResponse.Content.Contains('Baseline 0025') -or $dashboardResponse.Content.Contains('Baseline 0026') -or $dashboardResponse.Content.Contains('Baseline 0027') -or $dashboardResponse.Content.Contains('Baseline 0028') -or $dashboardResponse.Content.Contains('Baseline 0029') -or $dashboardResponse.Content.Contains('Baseline 0030') -or $dashboardResponse.Content.Contains('Baseline 0031') -or $dashboardResponse.Content.Contains('Baseline 0032') -or $dashboardResponse.Content.Contains('Baseline 0033') -or $dashboardResponse.Content.Contains('Baseline 0034'))
    ...
    $checks = [ordered]@{
        ...
        checkpoint_exact = $verification.checkpoint -eq 'baseline-0035'
        ...
        evaluation_checkpoint_exact = $verification.evaluation_checkpoint -eq 'baseline-0035'
        ...
        dashboard_baseline_exact = [bool]$verification.dashboard_baseline_0035
