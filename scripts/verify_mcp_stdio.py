...
def main() -> None:
    database = ROOT / "var/live-mcp-baseline-0031.db"
    trace = ROOT / "artifacts/runtime/live-mcp-baseline-0031-traces.jsonl"
    ...
    process = subprocess.Popen(
        [
            ...
            "mcp",
            "--db",
            "var/live-mcp-baseline-0031.db",
            "--trace",
            "artifacts/runtime/live-mcp-baseline-0031-traces.jsonl",
        ],
        cwd=ROOT,
        env=env,
    ...
    try:
        ...
        if initialized["result"]["serverInfo"]["version"] != "0.0.31":
