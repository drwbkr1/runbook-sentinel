...
def main() -> None:
    ...
    errors: list[str] = []
    if catalog.get("schema_version") != "1.4":
        errors.append("catalog schema must be 1.4")
    ...
    if execute_count != 5 or no_execute_count != 13:
        errors.append("terminal-state contract must retain 5 actionable and 13 no-action cases")
