...
def main() -> None:
    ...
    if catalog.get("schema_version") != "1.19":
        errors.append("catalog schema must be 1.19")
    ...
    if execute_count != 15 or no_execute_count != 42:
        errors.append("terminal-state contract must contain 15 actionable and 42 no-action cases")
