...
- Retain the public freeze arithmetic correction, stale exhaustive test fixture, no-artifact and reporting-wrapper failures, and documentation inventory guess alongside corrected results. Twenty-cell coverage is synthetic evidence, not universal prompt-injection resistance; 44 cases remain below the v0.1.0 target. Remote-only clone, review/merge, and public-release gates remain pending.
