...
- Revealed one immutable source candidate only after the public manifest seal. It passes 57 scenarios, 171 attempts, all 136 Boolean gates, exact independent retrieval-quality validation, and an anchored 261-event trace; report/trace SHA-256 are `a4dcd408…` / `96b3c309…`. Package, real-surface, and container verification remain separate and unopened until this exact candidate payload is public.
